...
public class PagingBeanMain {
	
	// 카테고리 default
	private String category = "";
	
	// 정렬기준 default
	private String sortBy = "product_up_time desc";
	...
	public PagingBeanMain() {
		super();
	}

	public PagingBeanMain(int totalPostCount) {
		this.totalPostCount = totalPostCount;
	}

	public PagingBeanMain(int totalPostCount, int nowPage) {
		this.totalPostCount = totalPostCount;
